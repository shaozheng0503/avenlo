...
IDEAS = [
    ...
    # related 引用落卡（idea_01 的 RELATED_TRAVEL 指向这三张；无 related 避免递归引用）
    _idea(11, "清晨的露水", "晨间露珠的微观摄影与光影观察。", ["自然", "摄影"], 30, 22000),
    _idea(12, "咖啡馆与工作", "咖啡馆作为第三空间的工位选择与观察笔记。", ["创作", "生活"], 44, 560000),
    _idea(13, "山野徒步", "城郊徒步路线的体力分配与风景节奏。", ["户外", "旅行"], 60, 315000),
]
