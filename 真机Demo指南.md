...
8. 灵感集页右上「+」可新建灵感集（server 落卡），2×2 照片网格；**点任意灵感集卡进内页**（第三十三轮）
9. **今日回顾三处卡片可点击跳详情**（第三十四轮）：今日最佳大卡、意外关联左右两卡（城市与人 × 夜骑的城市观察）——Q&A 深挖动线
10. **我的页统计三格可点击**（第三十五轮）：灵感/分钟→记录 Tab、灵感集→灵感集列表；设置四项点击有「正式版提供」提示
